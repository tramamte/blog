...
Go 언어에는 4 종류의 토큰이 있다: identifiers, keywords, operators and punctuation, literal.---자세한 사항은 [The Go Programming Language Specification](https://golang.org/ref/spec) 참고
...
Go의 타입이 뒤에 오는 비상식적---idiomatic 이라 주장하는--- 선언법과 초기화 문법 등을 모두 포함해 단 하나의 문장,
...
으로 표현해 버리는 용기, 그를 뒷받침하기 위해 identifier로 몰아버림으로써 익숙한 것들을 깨버리는 대범함. 멋지지 않은가?
